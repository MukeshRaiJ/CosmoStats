          ...
          {isOpen && (
            ...
            >
              ...
              <FilterSelect
                ...
                options={uniqueValues.mission}
                onChange={(value) =>
                  setFilters((prev) => ({ ...prev, mission: value }))
                }
                colors={colors}
              />
              <FilterSelect
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search satellites by name, mission, or vehicle..."
            value={searchTerm}
        ...
        >
          <span>
            Showing {filteredCount} of {totalCount} satellites
          </span>
